...
export function Partners() {
  ...
  return (
    <section id="partners" className="py-28" style={{ background: "var(--ss-cream, #F5F0F0)" }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {partners.map((p) => (
            ...
            >
              ...
              {/* Logo placeholder */}
              <div
                className="w-full h-20 flex items-center justify-center text-[11px] font-medium uppercase"
                style={{
              ...
              <h3 className="text-[20px] font-medium" style={{ color: "#0A0A0A" }}>
                {p.name}
              </h3>
              <p className="text-[14px] leading-relaxed font-light" style={{ color: "#6B6B6B" }}>
                {t(p.tr, p.en)}
              </p>
            </div>
          ))}
