...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-[1240px] mx-auto px-6 md:px-12 w-full">
        {/* Eyebrow */}
        <div
        ...
        >
          {t("Havacılığın görünmez riskini ", "We make aviation's invisible risk ")}
        ...
        <div className="flex flex-wrap gap-4 mb-24">
          ...
          >
            <a href="#investor">{t("Yatırımcı Bilgileri", "Investor Info")}</a>
          </Button>
